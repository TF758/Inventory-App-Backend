...
from sites.api.serializers.locations import LocationListSerializer, LocationNameSerializer, LocationReadSerializer
from sites.models.sites import Room,Location
