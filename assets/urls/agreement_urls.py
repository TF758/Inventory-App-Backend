...
from assets.api.viewsets.asset_agreement import AgreementCoverageViewSet, AgreementHistoryViewSet, AgreementItemHistoryViewSet
from core.viewsets.agreement_viewsets import AssetAgreementItemViewSet, AssetAgreementViewSet
...
urlpatterns = [
    ...
    path( "<str:public_id>/coverages/", AssetAgreementViewSet.as_view({ "get": "coverages", }), name="agreement-coverages", ),

    path( "<str:public_id>/items/", AssetAgreementViewSet.as_view({ "get": "items", }), name="agreement-items", ),

    path( "<str:public_id>/history/", AssetAgreementViewSet.as_view({ "get": "history", }), name="agreement-history", ),
    ...
    path( "item-history/", AgreementItemHistoryViewSet.as_view({ "get": "list", }), name="agreement-item-history-list", ),

    path( "item-history/<int:pk>/", AgreementItemHistoryViewSet.as_view({ "get": "retrieve", }), name="agreement-item-history-detail", ),
]
