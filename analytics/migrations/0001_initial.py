...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['snapshot_date', 'department'], name='analytics_d_snapsho_e7686f_idx')],
                'constraints': [models.UniqueConstraint(fields=('department', 'snapshot_date'), name='uniq_department_snapshot_per_day')],
            },
        ),
    ]
