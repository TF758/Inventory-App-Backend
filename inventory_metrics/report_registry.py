...
from inventory.reporting.services.asset_reports import build_asset_history_report
from inventory.reporting.services.site_reports import build_site_asset_report, build_site_audit_log_report
from inventory.reporting.services.user_summary import build_user_audit_history_report, build_user_login_history_report, build_user_summary_report
from inventory.reporting.utils.report_adapters.asset_reports import asset_history_to_workbook_spec
from inventory.reporting.utils.report_adapters.site_reports import site_asset_to_workbook_spec, site_audit_log_to_workbook_spec
from inventory.reporting.utils.report_adapters.user_summary import user_audit_history_to_workbook_spec, user_login_history_to_workbook_spec, user_summary_to_workbook_spec
from inventory.reporting.utils.resolve_audit_date_range import resolve_report_date_range
...
def user_login_history_params(params, user):

    start_date, end_date = resolve_report_date_range(params)
...
def asset_history_params(params, user):
    return {
...
REPORT_DEFINITIONS = {
 ...
 "user_audit_history": {
    ...
    "user_login_history": {
    "builder": build_user_login_history_report,
    "renderer": user_login_history_to_workbook_spec,
    "param_map": user_login_history_params,
    "streaming": True,
},
"asset_history": {
