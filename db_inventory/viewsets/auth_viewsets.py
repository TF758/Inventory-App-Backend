...
from db_inventory.serializers.auth import AuditLogSerializer, ChangePasswordSerializer, AdminPasswordResetSerializer, AuditLogLightSerializer, AdminUserDemographicsSerializer
...
class AuditLogViewSet(ScopeFilterMixin,viewsets.ReadOnlyModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        if user.is_superuser or (role and role.role == "SITE_ADMIN"):
            return AuditLogSerializer   # heavy
